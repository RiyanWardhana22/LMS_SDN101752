...
export default function Reports() {
  ...
  useEffect(() => {
    const fetchReports = async () => {
      setLoading(true);
      try {
        const response = await fetch(apiEndpoint("api/admin/reports.php"));
  ...
  const handleDownload = (type) => {
    window.open(
      apiEndpoint(`api/admin/export_reports.php?type=${type}`),
      "_blank",
    );
  };
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-neutral-500 font-medium">
            Pantau statistik pengguna, performa akademik, dan aktivitas belajar.
          </p>
        </div>
        <div>
          <select
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <div className="h-72">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart
                    data={reportData.distribusi_kelas}
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-bold text-gray-900">
                  Rata-Rata Nilai Akademik per Kelas
                </h3>
              ...
              <div className="h-72">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart
                    data={reportData.rata_rata_nilai}
                    margin={{ top: 10, right: 10, left: -20, bottom: 0 }}
                  >
                    <CartesianGrid
                      strokeDasharray="3 3"
          ...
          <div>
            <div className="mb-6">
              <h3 className="text-xl font-bold text-gray-900">
                Dokumentasi & Ekspor Laporan
              </h3>
              <p className="text-sm text-gray-500 font-medium mt-1">
                Unduh rekapitulasi data otomatis dalam format CSV/Excel untuk
                keperluan laporan akhir Pengabdian Masyarakat kampus.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h4 className="font-bold text-gray-800 mb-2">
                  Laporan Penggunaan LMS
                </h4>
                <p className="text-xs text-gray-500 mb-6">
                  Tren keaktifan login dan akses materi dari bulan ke bulan.
                </p>
                <button
              ...
              <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-xs text-gray-500 mb-6">
                  Rekap nilai rata-rata siswa, ketuntasan, dan jumlah tugas.
                </p>
                <button
              ...
              <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-xs text-gray-500 mb-6">
                  Statistik pembuatan materi dan interaksi guru dengan siswa.
                </p>
                <button
