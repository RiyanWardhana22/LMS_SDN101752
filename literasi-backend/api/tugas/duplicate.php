...
try {
            ...
            if ($id) {
                        ...
                        if ($orig) {
                                    ...
                                    $ins = $db->prepare("INSERT INTO tugas_kuis (guru_id, rombel_id, judul, deskripsi, tipe, tenggat) VALUES (:g, :r, :j, :d, :t, :tg)");
                                    $ins->execute([
                                                ':g' => $orig['guru_id'],
                                                ':r' => $orig['rombel_id'],
                                                ':j' => $new_title,
                                    ...
                                    echo json_encode(["status" => "error", "message" => "Evaluasi asli tidak ditemukan."]);
                        }
            } else {
